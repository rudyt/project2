...
//Send message below
           function sendMessage(){
                ...
                socket.emit('sendMessage', {'message': message},{'displayname':displayname},{'timestamp':timestamp},{'channel':chl});
                console.log('sent message='+message +'displayname='+displayname+'timestamp='+timestamp );
